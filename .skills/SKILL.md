...
* Generated File Safety: Do not edit files that are generated or explicitly marked as generated, and do not modify files that contain warnings such as "DO NOT EDIT" or "Generated by the protocol buffer compiler.". If a generated file needs adaptation, prefer a build-system or wrapper-based approach (for example, defining a macro or generating a wrapper) rather than editing the generated source directly.
---
